...
epl_agent = Agent(
    name="EPL Agent",
    instructions="""You are a data querying agent. Handling questions related to data queries for the English Premier League. 
    You should only answer questions based on the response from your functions.
    You should only answer questions for the teams in the English Premier League.""",
    functions=[query_epl],
)

laliga_agent = Agent(
    name="Laliga Agent",
    instructions="""You are a data querying agent. Handling questions related to data queries for the Spanish Premier League. 
    You should only answer questions based on the response from your functions.
    You should only answer questions for the teams in the Spanish Premier League.""",
...
manager = Agent(
    name="Manager Agent",
    instructions="""You are a manager agent responsible for routing queries to specialized agents and handling personal interactions.
